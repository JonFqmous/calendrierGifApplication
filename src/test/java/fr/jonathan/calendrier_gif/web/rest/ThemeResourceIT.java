...
import fr.jonathan.calendrier_gif.repository.ThemeRepository;
...
class ThemeResourceIT {
    ...
    public static Theme createEntity(EntityManager em) {
        Theme theme = new Theme().nom(DEFAULT_NOM);
        return theme;
    }
    ...
    public static Theme createUpdatedEntity(EntityManager em) {
        Theme theme = new Theme().nom(UPDATED_NOM);
        return theme;
    }
    ...
    void createTheme() throws Exception {
        ...
        assertThat(testTheme.getNom()).isEqualTo(DEFAULT_NOM);
    }
    ...
    void putNewTheme() throws Exception {
        ...
        Theme testTheme = themeList.get(themeList.size() - 1);
        assertThat(testTheme.getNom()).isEqualTo(UPDATED_NOM);
    }
    ...
    void fullUpdateThemeWithPatch() throws Exception {
        ...
        partialUpdatedTheme.nom(UPDATED_NOM);
