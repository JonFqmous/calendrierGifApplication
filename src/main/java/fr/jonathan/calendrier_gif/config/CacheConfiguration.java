package fr.jonathan.calendrier_gif.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.jonathan.calendrier_gif.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.jonathan.calendrier_gif.repository.UserRepository.USERS_BY_EMAIL_CACHE);
