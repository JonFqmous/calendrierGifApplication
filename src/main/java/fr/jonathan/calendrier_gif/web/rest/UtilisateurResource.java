...
/**
 * REST controller for managing {@link fr.jonathan.calendrier_gif.domain.Utilisateur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Utilisateur> partialUpdateUtilisateur(
        ...
        Optional<Utilisateur> result = utilisateurRepository
            ...
            .map(existingUtilisateur -> {
                ...
                if (utilisateur.getNbPoint() != null) {
                    existingUtilisateur.setNbPoint(utilisateur.getNbPoint());
                }
                if (utilisateur.getDateHeureInscription() != null) {
                    existingUtilisateur.setDateHeureInscription(utilisateur.getDateHeureInscription());
                }
